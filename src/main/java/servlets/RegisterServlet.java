...
public class RegisterServlet extends HttpServlet {
	...
	//service()
	//and destroy()
	// the service() methods doPost(),doGet(),doHead(),doDelete(),
	//doOptions() and doTrace() HTTP callback methods are called
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		//settings MIME type (Multipurpose Internet Mail Extension)
		//this will tell the browser what type of response we are 
		//sending from servlet
